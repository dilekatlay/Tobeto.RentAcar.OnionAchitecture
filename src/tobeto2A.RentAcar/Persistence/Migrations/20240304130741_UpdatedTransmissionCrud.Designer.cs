...
namespace Persistence.Migrations
{
    ...
    [Migration("20240304130741_UpdatedTransmissionCrud")]
    partial class UpdatedTransmissionCrud
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3dcb5b61-2c70-4126-8485-d2e74a8bbb6c"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 94, 156, 33, 51, 164, 220, 53, 121, 214, 227, 157, 78, 51, 184, 101, 85, 243, 143, 40, 173, 77, 174, 8, 184, 57, 210, 232, 145, 47, 35, 211, 151, 131, 195, 133, 85, 16, 107, 212, 107, 77, 83, 17, 104, 55, 207, 218, 104, 130, 95, 34, 148, 188, 145, 63, 22, 164, 211, 197, 53, 135, 253, 190, 254 },
                            PasswordSalt = new byte[] { 231, 149, 196, 174, 52, 171, 117, 175, 204, 71, 239, 233, 202, 153, 224, 178, 53, 106, 224, 230, 0, 61, 244, 173, 252, 43, 160, 202, 236, 184, 43, 115, 161, 207, 137, 49, 139, 220, 106, 24, 248, 209, 43, 123, 110, 78, 138, 44, 132, 32, 64, 213, 192, 105, 76, 175, 174, 81, 254, 250, 211, 176, 28, 67, 209, 18, 208, 25, 120, 78, 47, 175, 128, 250, 14, 3, 66, 172, 85, 148, 238, 58, 199, 213, 92, 244, 135, 180, 189, 22, 62, 25, 218, 125, 15, 102, 139, 28, 148, 179, 4, 141, 38, 98, 159, 34, 232, 130, 148, 213, 171, 19, 160, 12, 57, 162, 59, 243, 77, 195, 134, 199, 211, 142, 144, 212, 245, 26 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b4c94077-8d9a-4e6b-b315-e62d086d306a"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("3dcb5b61-2c70-4126-8485-d2e74a8bbb6c")
                        });
                });
